        ...
        <div class="mb-4">
            ...
            >
                ...
                <div class="mb-4 flex items-center justify-between">
                        <div></div>
                       <div class="flex-shrink-0">
                            <Link :href="route('admin.time-ranges.trashed')" class="uppercase hover:underline hover:decoration-solid hover:decoration-slate-500 dark:text-slate-300">Перейти в корзину</Link>
                        </div>
                </div>
